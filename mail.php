...
class ContactForm {
    ...
    public function sendEmail($name, $email, $phone, $message) {
        $email_content = $this->buildEmailContent($name, $email, $phone,  $message);
    ...
    private function buildEmailContent($name, $email, $phone,  $message) {
        $content = "";
        $fields = array(
            "Name" => $name,
            "Email" => $email,
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $contactForm->sendEmail($name, $email, $phone,  $message);
} else {
